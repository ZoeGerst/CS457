...
Display( )
{
	...
	PleatsCube->Use( );
	PleatsCube->SetUniformVariable( "uKa", 0.1f );
	PleatsCube->SetUniformVariable( "uKd", 0.6f );
	PleatsCube->SetUniformVariable( "uKs", 0.3f );
	PleatsCube->SetUniformVariable( "uShininess", 8.f );

	PleatsCube->SetUniformVariable( "uS0", S0);
	PleatsCube->SetUniformVariable( "uT0", T0 );
	PleatsCube->SetUniformVariable( "uD", D*(float)(.5+.5*sin(2.*M_PI*Time)) );
	PleatsCube->SetUniformVariable( "uTime",  Time );
...
InitGraphics( )
{
	...
	PleatsCube = new GLSLProgram( );
	bool valid = PleatsCube->Create( "pleatscube.vert",  "pleatscube.frag" );
	if( ! valid )
	{
