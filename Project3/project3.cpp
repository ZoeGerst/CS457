...
Display( )
{
	...
	Pleats->Use( );
	Pleats->SetUniformVariable( "uKa", 0.1f );
	Pleats->SetUniformVariable( "uKd", 0.6f );
	Pleats->SetUniformVariable( "uKs", 0.3f );
	Pleats->SetUniformVariable( "uShininess", 8.f );

	Pleats->SetUniformVariable( "uS0", S0);
	Pleats->SetUniformVariable( "uT0", T0 );
	Pleats->SetUniformVariable( "uD", D*(float)(.5+.5*sin(2.*M_PI*Time)) );
	Pleats->SetUniformVariable( "uTime",  Time );
...
InitGraphics( )
{
	...
	Pleats = new GLSLProgram( );
	bool valid = Pleats->Create( "pleats.vert",  "pleats.frag" );
	if( ! valid )
	{
