...
Display( )
{
	...
	Oval->Use( );
	Oval->SetUniformVariable( "uKa", 0.1f );
	Oval->SetUniformVariable( "uKd", 0.6f );
	Oval->SetUniformVariable( "uKs", 0.3f );
	Oval->SetUniformVariable( "uShininess", 8.f );

	Oval->SetUniformVariable( "uS0", S0);
	Oval->SetUniformVariable( "uT0", T0 );
	Oval->SetUniformVariable( "uD", D*(float)(.5+.5*sin(2.*M_PI*Time)) );
	Oval->SetUniformVariable( "uTime",  Time );
...
InitGraphics( )
{
	...
	bool valid = Oval->Create( "oval.vert",  "oval.frag" );
	if( ! valid )
	{
