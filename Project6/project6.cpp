...
Display( )
{
	...
	Bunny->Use( );
	Bunny->SetUniformVariable( "uKa", 0.1f );
	Bunny->SetUniformVariable( "uKd", 0.6f );
	Bunny->SetUniformVariable( "uKs", 0.3f );
	Bunny->SetUniformVariable( "uShininess", 8.f );

	Bunny->SetUniformVariable( "uS0", S0);
	Bunny->SetUniformVariable( "uT0", T0 );
	Bunny->SetUniformVariable( "uD", D*(float)(.5+.5*sin(2.*M_PI*Time)) );
	Bunny->SetUniformVariable( "uTime",  Time );
...
InitGraphics( )
{
	...
	Bunny = new GLSLProgram( );
	bool valid = Bunny->Create( "bunny.vert",  "bunny.frag" );
	if( ! valid )
	{
