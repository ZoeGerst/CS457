...
Display( )
{
	...
	Hedgehog->Use( );
	Hedgehog->SetUniformVariable( "uKa", 0.1f );
	Hedgehog->SetUniformVariable( "uKd", 0.6f );
	Hedgehog->SetUniformVariable( "uKs", 0.3f );
	Hedgehog->SetUniformVariable( "uShininess", 8.f );

	Hedgehog->SetUniformVariable( "uS0", S0);
	Hedgehog->SetUniformVariable( "uT0", T0 );
	Hedgehog->SetUniformVariable( "uD", D*(float)(.5+.5*sin(2.*M_PI*Time)) );
	Hedgehog->SetUniformVariable( "uTime",  Time );
...
InitGraphics( )
{
	...
	Hedgehog = new GLSLProgram( );
	bool valid = Hedgehog->Create( "hedgehog.vert",  "hedgehog.frag", "hedgehog.geom");
	if( ! valid )
	{
