...
Display( )
{
	...
	Cylquant->Use( );
	Cylquant->SetUniformVariable( "uKa", 0.1f );
	Cylquant->SetUniformVariable( "uKd", 0.6f );
	Cylquant->SetUniformVariable( "uKs", 0.3f );
	Cylquant->SetUniformVariable( "uShininess", 8.f );

	Cylquant->SetUniformVariable( "uS0", S0);
	Cylquant->SetUniformVariable( "uT0", T0 );
	Cylquant->SetUniformVariable( "uD", D*(float)(.5+.5*sin(2.*M_PI*Time)) );
	Cylquant->SetUniformVariable( "uTime",  Time );
...
InitGraphics( )
{
	...
	Cylquant = new GLSLProgram( );
	bool valid = Cylquant->Create( "cylquant.vert",  "cylquant.frag" );
	if( ! valid )
	{
